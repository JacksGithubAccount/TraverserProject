...
{
    [CreateAssetMenu(menuName = "Items/Spells/Lightning Spear")]
    public class LightningSpearSpell : SpellItem
    {
        [Header("Projectile Velocity")]
        [SerializeField] float upwardVelocity = 0;
        [SerializeField] float forwardVelocity = 25;
        ...
        public override void SuccessfullyCastSpell(PlayerManager player)
        {
            ...
            LightningSpearManager lightningSpearManager = instantiatedReleasedSpellFX.GetComponent<LightningSpearManager>();
            lightningSpearManager.InitializeLightningSpear(player);
        ...
        public override void SuccessfullyCastSpellFullCharge(PlayerManager player)
        {
            ...
            LightningSpearManager lightningSpearManager = instantiatedReleasedSpellFX.GetComponent<LightningSpearManager>();
            lightningSpearManager.isFullyCharged = true;
            lightningSpearManager.InitializeLightningSpear(player);
