...
namespace TraverserProject
{
    ...
    public class LadderInteractable : Interactable
    {
        ...
        [SerializeField] string climbUpLadderExitUpRightAnimation = "Climb_Up_Ladder_Exit_R_01";
        [SerializeField] string climbUpLadderExitUpLeftAnimation = "Climb_Up_Ladder_Exit_L_01";
        [SerializeField] string climbUpLadderExitDownRightAnimation = "Climb_Down_Ladder_Exit_R_01";
        [SerializeField] string climbUpLadderExitDownLeftAnimation = "Climb_Down_Ladder_Exit_L_01";
        ...
        private void CheckForExit(PlayerManager player)
        {
            ...
            if (isTopOfLadder)
            {
                ...
                {
                    player.playerAnimatorManager.PlayTargetActionAnimation(climbUpLadderExitUpRightAnimation, true);
                }
                else if (player.playerLocomotionManager.canExitLadderWithLeftHand)
                {
                    player.playerAnimatorManager.PlayTargetActionAnimation(climbUpLadderExitUpLeftAnimation, true);
                }
            ...
            if (PlayerInputManager.Singleton.verticalInput < 0 || player.playerNetworkManager.isSlidingDownLadder.Value)
            {
                ...
                if (player.playerLocomotionManager.canExitLadderWithRightHand)
                {
                    player.playerAnimatorManager.PlayTargetActionAnimationInstantly(climbUpLadderExitDownRightAnimation, true);
                }
                else
                {
                    player.playerAnimatorManager.PlayTargetActionAnimationInstantly(climbUpLadderExitDownLeftAnimation, true);
                }
            }
